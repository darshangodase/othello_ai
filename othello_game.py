...
class OthelloGame:
    def __init__(self, player_mode="friend"):
        ...
        self.score_tracker = ScoreTracker()  # Initialize the score tracker
        self.score_tracker.update_score(self.board)  # Initialize scores
    ...
    def make_move(self, row, col):
        ...
        if self.is_valid_move(row, col):
            ...
            # Update the score after making a valid move
            self.score_tracker.update_score(self.board)
            # Switch players
            self.current_player *= -1
    ...
    def get_scores(self):
        ...
        """
        return self.score_tracker.get_scores()  # Return the scores from the score tracker